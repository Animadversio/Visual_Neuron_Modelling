...
def corr_GAN_visualize(scorer, CNNnet, preprocess, layername, savestr="", figdir="", lr=0.01, imgfullpix=224, MAXSTEP=50, Bsize=4):
    """  """
...
for Animal in ["Alfa",]: # "Beto"
    for Expi in range(27,46+1):
        ...
        imgs5, mtg5, score_traj5 = corr_GAN_visualize(scorer, VGG.features, preprocess, "conv5_3", lr=0.080, imgfullpix=224, MAXSTEP=75, Bsize=4, savestr=savefn, figdir=figdir)
        imgs4, mtg4, score_traj4 = corr_GAN_visualize(scorer, VGG.features, preprocess, "conv4_3", lr=0.025, imgfullpix=224, MAXSTEP=75, Bsize=4, savestr=savefn, figdir=figdir)
        imgs3, mtg3, score_traj3 = corr_GAN_visualize(scorer, VGG.features, preprocess, "conv3_3", lr=0.01, imgfullpix=224, MAXSTEP=75, Bsize=4, savestr=savefn, figdir=figdir)
